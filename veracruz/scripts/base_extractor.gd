...
var extractor_configs = {
	"lumbermill": {
		...
		"production_cycle": 1,  # Mensual
		"texture_paths": [
			"res://assets/extractors/lumbermill_1.png",
			"res://assets/extractors/lumbermill_2.png",
			"res://assets/extractors/lumbermill_3.png",
			"res://assets/extractors/lumbermill_4.png"
		]
	},
	"quarry": {
		"name": "Cantera",
		...
		"production_cycle": 1,  # Mensual
		"texture_paths": [
			"res://assets/extractors/quarry_1.png",
			"res://assets/extractors/quarry_2.png",
			"res://assets/extractors/quarry_3.png",
			"res://assets/extractors/quarry_4.png"
		]
	},
	"plantation": {
		"name": "Plantación",
		"resource": "corn",  # Puede variar según la zona
		"max_workers": [20, 30, 40, 50],
		"base_production": [30, 60, 90, 130],  # Mayor producción pero...
		"production_cycle": 6,  # ...cada 6 meses!
		"texture_paths": [
			"res://assets/extractors/plantation_1.png",
			"res://assets/extractors/plantation_2.png",
			"res://assets/extractors/plantation_3.png",
			"res://assets/extractors/plantation_4.png"
		]
	}
}
...
func _ready() -> void:
	...
	var config = extractor_configs.get(extractor_type, {})
...
func _update_visual() -> void:
	...
	var texture_paths = config.get("texture_paths", [])
	if current_level < texture_paths.size():
		var texture_path = texture_paths[current_level]
		# Solo cargar si el archivo existe
		if ResourceLoader.exists(texture_path):
			sprite.texture = load(texture_path)
		else:
			# Crear un placeholder si no existe la textura
